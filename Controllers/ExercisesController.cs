...
namespace DevUtilitiesV2MVCApp.Controllers
{
    public class ExercisesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Exercise,Solution,VarableData,ExerciseLevel,ProjectType,Langues,ExpectedSolution,PostedDate,ModifiedDate")] Exercises exercises)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Exercise,Solution,VarableData,ExerciseLevel,ProjectType,Langues,ExpectedSolution,PostedDate,ModifiedDate")] Exercises exercises)
        {
            if (id != exercises.Id)
            {
                return NotFound();
